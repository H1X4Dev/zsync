...
void MD4Transform(uint32_t[4], const uint8_t[MD4_BLOCK_LENGTH]) ZS_DECL_BOUNDED(__minbytes__, 1, 4) ZS_DECL_BOUNDED(__minbytes__, 2, MD4_BLOCK_LENGTH);
...
char* MD4Data(const uint8_t*, size_t, char*) ZS_DECL_BOUNDED(__string__, 1, 2) ZS_DECL_BOUNDED(__minbytes__, 3, MD4_DIGEST_STRING_LENGTH);
